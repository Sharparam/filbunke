...
Devise.setup do |config|
  ...
  # config.secret_key = '45fbb5fe225aaafe2e34474cffacc6b1f4d22c8cecdf1c6859f161d5665a9064037f7dca8321563445c61f1914292df16ac59239eb5950fc09f27c4c047c6eae'
  ...
  config.mailer_sender = 'filbunke-devise@example.com'
  ...
  gh_client_id = ENV.fetch('GITHUB_CLIENT_ID') do
    Rails.application.credentials.dig :github, :client_id
  end
  gh_client_secret = ENV.fetch('GITHUB_CLIENT_SECRET') do
  ...
  config.omniauth :gitlab, gl_client_id, gl_client_secret, scope: 'read_user openid profile email'
